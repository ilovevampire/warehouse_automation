...
def launch_setup(context, *args, **kwargs):
    ...
    warehouse_gazebo_pkg = FindPackageShare("warehouse_gazebo")
    ...
    world_file = PathJoinSubstitution(
        [warehouse_gazebo_pkg, "worlds", "warehouse.sdf"]
    )
...
def generate_launch_description():
    ...
    set_gz_resource_path = SetEnvironmentVariable(
        ...
        value=os.path.expanduser("~") + "/warehouse_ws/install/robotiq_description/share:"
            ...
            + os.path.expanduser("~") + "/warehouse_ws/install/warehouse_gazebo/share/warehouse_gazebo/models",
    )
